...
public class Activity_Groups extends AppCompatActivity {
    ...
    private String getFilePathFromUri(Uri uri) {
        ...
        // If DISPLAY_NAME is not available, fallback to extracting from URI
        if (displayName == null) {
            displayName = uri.getLastPathSegment();
        }

        // Copy content:// file to app's private directory if needed
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_ImportExcel_Group = findViewById(R.id.btn_ImportExcel_Group);
